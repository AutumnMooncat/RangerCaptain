...
public class BlossomawMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(BlossomawMod.class.getSimpleName());
