...
public class SpitzfyreMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(SpitzfyreMod.class.getSimpleName());
