...
public class PalangolinMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(PalangolinMod.class.getSimpleName());
