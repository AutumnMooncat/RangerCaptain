...
public class AeroborosMod extends AbstractExtraEffectFusionMod {
    ...
    public static final int AMOUNT2 = 6;
    ...
    public AeroborosMod() {
        super(ID, AbstractExtraEffectFusionMod.VarType.DAMAGE_DIRECT, AMOUNT);
    }
