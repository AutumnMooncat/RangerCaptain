...
public class GrampusMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(GrampusMod.class.getSimpleName());
