...
public class MacabraMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(MacabraMod.class.getSimpleName());
