...
public class RatcouselMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(RatcouselMod.class.getSimpleName());
