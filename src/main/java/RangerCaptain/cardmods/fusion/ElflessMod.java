...
public class ElflessMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(ElflessMod.class.getSimpleName());
