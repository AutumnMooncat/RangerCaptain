...
public class LobstacleMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(LobstacleMod.class.getSimpleName());
