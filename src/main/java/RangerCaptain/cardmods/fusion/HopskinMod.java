...
public class HopskinMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(HopskinMod.class.getSimpleName());
