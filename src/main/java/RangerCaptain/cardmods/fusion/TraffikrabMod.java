...
public class TraffikrabMod extends AbstractExtraEffectFusionMod {
    public static final String ID = MainModfile.makeID(TraffikrabMod.class.getSimpleName());
