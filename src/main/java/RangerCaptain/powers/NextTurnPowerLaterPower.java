...
public class NextTurnPowerLaterPower extends AbstractEasyPower {
    ...
    public NextTurnPowerLaterPower(AbstractCreature owner, AbstractPower powerToGrant) {
        super(TEXT_ID+powerToGrant.name, strings.NAME + powerToGrant.name, powerToGrant.type, false, owner, powerToGrant.amount);
