...
public class StashNextCardComponent extends AbstractComponent {
    public static final String ID = MainModfile.makeID(StashNextCardComponent.class.getSimpleName());
    ...
    public AbstractComponent makeCopy() {
        return new StashNextCardComponent(baseAmount);
    }
}
