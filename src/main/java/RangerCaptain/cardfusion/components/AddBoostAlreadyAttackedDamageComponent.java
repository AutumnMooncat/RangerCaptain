...
import RangerCaptain.damageMods.BoostAlreadyAttackedDamage;
...
public class AddBoostAlreadyAttackedDamageComponent extends AbstractDamageModComponent {
    public static final String ID = MainModfile.makeID(AddBoostAlreadyAttackedDamageComponent.class.getSimpleName());
    ...
    public AbstractComponent makeCopy() {
        return new AddBoostAlreadyAttackedDamageComponent(baseAmount);
    }
}
