...
public class ToxinComponent extends AbstractSimpleApplyComponent {
    public static final String ID = MainModfile.makeID(ToxinComponent.class.getSimpleName());
    ...
    public AbstractPower getPower(AbstractCreature target, int amount) {
        return new ToxinPower(target, amount);
    }

    @Override
    public AbstractComponent makeCopy() {
        return new ToxinComponent(baseAmount, target);
    }
}
