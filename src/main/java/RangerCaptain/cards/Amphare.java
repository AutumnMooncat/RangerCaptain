...
public class Amphare extends AbstractEasyCard {
    ...
    static {
        new FusionComponentHelper(MonsterEnum.AMPHARE)
                ...
                .withFlags(new ConductiveComponent(4), AbstractComponent.Flag.INVERSE_PREFERRED)
                .register();
        new FusionComponentHelper(MonsterEnum.LAPACITOR)
                .withCost(1)
                .with(new OnGainEnergyComponent())
                .withFlags(new ConductiveComponent(6), AbstractComponent.Flag.INVERSE_PREFERRED)
                .register();
    }
